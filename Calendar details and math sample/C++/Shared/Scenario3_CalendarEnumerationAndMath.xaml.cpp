...
#include "pch.h"
#include "Scenario3_CalendarEnumerationAndMath.xaml.h"
...
void SDKSample::CalendarSample::CalendarEnumerationAndMath::Display_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    // Store results here
    String^ results = "The number of years in each era of the Japanese era calendar is not regular. It is determined by the length of the given imperial era:\n";
    ...
    Calendar^ currentCal = ref new Windows::Globalization::Calendar(en, CalendarIdentifiers::Gregorian, ClockIdentifiers::TwentyFourHour, "america/los_angeles");
