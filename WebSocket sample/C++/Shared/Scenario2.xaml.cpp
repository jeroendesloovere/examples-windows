...
void SDKSample::WebSocket::Scenario2::Start_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::WebSocket::Scenario2::HandleException(Exception^ exception)
{
...
void SDKSample::WebSocket::Scenario2::Scenario2SendData()
{
    // Make a local copy to avoid races with the Closed event.
    StreamWebSocket^ webSocket = this->streamWebSocket;
    if (webSocket == nullptr)
...
void SDKSample::WebSocket::Scenario2::Scenario2ReceiveData()
{
    // Make a local copy to avoid races with the Closed event.
    StreamWebSocket^ webSocket = this->streamWebSocket;
    if (webSocket == nullptr)
...
void SDKSample::WebSocket::Scenario2::Stop_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
    try
    {
...
void SDKSample::WebSocket::Scenario2::Scenario2Closed(IWebSocket^ sender, WebSocketClosedEventArgs^ args)
{
...
void SDKSample::WebSocket::Scenario2::MarshalText(TextBox^ output, String^ value)
{
...
void SDKSample::WebSocket::Scenario2::MarshalText(TextBox^ output, String^ value, bool append)
{
