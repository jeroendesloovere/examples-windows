...
using namespace SDKSample::WebSocket;
...
void SDKSample::WebSocket::Scenario1::Start_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void SDKSample::WebSocket::Scenario1::HandleException(Exception^ exception)
{
...
void SDKSample::WebSocket::Scenario1::SendMessage()
{
...
void SDKSample::WebSocket::Scenario1::MessageReceived(MessageWebSocket^ sender, MessageWebSocketMessageReceivedEventArgs^ args)
{
...
void SDKSample::WebSocket::Scenario1::Close_Click(Object^ sender, RoutedEventArgs^ e)
{
    try
    {
...
void SDKSample::WebSocket::Scenario1::Closed(IWebSocket^ sender, WebSocketClosedEventArgs^ args)
{
...
void SDKSample::WebSocket::Scenario1::MarshalText(TextBox^ output, String^ value)
{
...
void SDKSample::WebSocket::Scenario1::MarshalText(TextBox^ output, String^ value, bool append)
{
