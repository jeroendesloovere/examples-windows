...
using namespace SDKSample::Syndication;
...
void SDKSample::Syndication::Scenario1::GetFeed_Click(Object^ sender, RoutedEventArgs^ e)
{
    OutputField->Text = "";
...
void SDKSample::Syndication::Scenario1::DisplayFeed()
{
...
void SDKSample::Syndication::Scenario1::PreviousItem_Click(Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::Syndication::Scenario1::NextItem_Click(Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::Syndication::Scenario1::DisplayCurrentItem()
{
...
void SDKSample::Syndication::Scenario1::LinkField_Click(Object^ sender, RoutedEventArgs^ e)
{
