...
#include "pch.h"
#include "Scenario6_PostMultipart.xaml.h"
...
void Scenario6::Start_Click(Object^ sender, RoutedEventArgs^ e)
{
    Helpers::ScenarioStarted(StartButton, CancelButton, OutputField);
    rootPage->NotifyUser("In progress", NotifyType::StatusMessage);

    HttpMultipartFormDataContent^ form = ref new HttpMultipartFormDataContent();
    form->Add(ref new HttpStringContent(RequestBodyField->Text), "data");
    ...
    create_task(httpClient->PostAsync(resourceAddress, form), cancellationTokenSource.get_token()).then(
...
void Scenario6::Cancel_Click(Object^ sender, RoutedEventArgs^ e)
{
