...
#include "pch.h"
#include "Scenario1_oAuthFacebook.xaml.h"
...
#if WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP
void SDKSample::WebAuthentication::Scenario1::ContinueWebAuthentication(WebAuthenticationBrokerContinuationEventArgs^ args)
{
	...
	{
		FacebookReturnedToken->Text += "HTTP Error returned by AuthenticateAsync() : " + result->ResponseErrorDetail;
	}
	else
	{
		String^ statusString;
		...
		FacebookReturnedToken->Text += "Error returned by AuthenticateAsync() : " + statusString;
	}
