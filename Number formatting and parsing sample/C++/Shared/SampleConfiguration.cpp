...
Platform::Array<Scenario>^ MainPage::scenariosInner = ref new Platform::Array<Scenario>  
{
    ...
    { "Rounding and Padding", "SDKSample.NumberFormatting.RoundingAndPadding" },
    { "Numeral System Translation", "SDKSample.NumberFormatting.NumeralSystemTranslation" },
    { "Formatting/Translation using Unicode Extensions", "SDKSample.NumberFormatting.UsingUnicodeExtensions" }
}; 
