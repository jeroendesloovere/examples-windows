...
//
// NumberParsing.xaml.cpp
// Implementation of the NumberParsing class
//
...
void NumberParsing::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void SDKSample::NumberFormatting::NumberParsing::Display_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
