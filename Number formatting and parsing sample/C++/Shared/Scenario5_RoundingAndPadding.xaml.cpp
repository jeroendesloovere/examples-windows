...
//
// RoundingAndPadding.xaml.cpp
// Implementation of the RoundingAndPadding class
//
...
RoundingAndPadding::RoundingAndPadding()
{
    InitializeComponent();
}
...
void RoundingAndPadding::OnNavigatedTo(NavigationEventArgs^ e)
{
...
String^ RoundingAndPadding::DisplayRoundingAlgorithmAsString(RoundingAlgorithm roundingAlgorithm) 
{
...
/// </param>
String^ RoundingAndPadding::DoPaddingScenarios(INumberFormatter^ formatter) 
{
...
String^ RoundingAndPadding::DoPaddingAndRoundingScenarios(RoundingAlgorithm roundingAlgorithm, unsigned int significantDigits, int integerDigits, int fractionalDigits) 
{
...
/// <param name="roundingAlgorithm"></param>
String^ RoundingAndPadding::DoCurrencyRoundingScenarios(String^ currencyCode, RoundingAlgorithm roundingAlgorithm) 
{
...
///</summary>
///<param name="roundingAlgorithm"></param>
String^ RoundingAndPadding::DoIncrementRoundingScenarios(RoundingAlgorithm roundingAlgorithm) 
{
    // Create the rounder and set the rounding algorithm provided as a parameter
    IncrementNumberRounder^ rounder = ref new Windows::Globalization::NumberFormatting::IncrementNumberRounder();
    rounder->RoundingAlgorithm = roundingAlgorithm;
...
/// </summary>
/// <param name="roundingAlgorithm"></param>
String^ RoundingAndPadding::DoSignificantDigitRoundingScenarios(RoundingAlgorithm roundingAlgorithm) 
{
    // Create the rounder and set the rounding algorithm provided as a parameter.
...
/// <param name="e"></param>
void SDKSample::NumberFormatting::RoundingAndPadding::Display_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
