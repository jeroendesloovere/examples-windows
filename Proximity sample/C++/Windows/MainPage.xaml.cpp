...
void MainPage::OnNavigatedTo(NavigationEventArgs^ e)
{
    ...
    if (launchArgs != nullptr)
    {
        ...
        else if (launchArgs == "Windows.Networking.Proximity.PeerFinder:StreamSocket Role=Host")
        {
            m_IsLaunchedByTap = true;
            m_Role = Windows::Networking::Proximity::PeerRole::Host;
        }
        else if (launchArgs == "Windows.Networking.Proximity.PeerFinder:StreamSocket Role=Client")
        {
            m_IsLaunchedByTap = true;
            m_Role = Windows::Networking::Proximity::PeerRole::Client;
        }
    }
