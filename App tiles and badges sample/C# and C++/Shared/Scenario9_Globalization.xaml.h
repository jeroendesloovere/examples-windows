...
#include "pch.h"
#include "Scenario9_Globalization.g.h"
...
namespace SDKSample
{
    namespace Tiles
    {
        ...
        private:
            ...
            void SendScaledImageTileNotification_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
            void SendTextResourceTileNotification_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
        };
    }
}