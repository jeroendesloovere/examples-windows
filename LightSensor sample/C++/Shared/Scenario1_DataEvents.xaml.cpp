...
void Scenario1::VisibilityChanged(Object^ sender, VisibilityChangedEventArgs^ e)
{
    ...
    if (ScenarioDisableButton->IsEnabled)
    {
        if (e->Visible)
        {
            ...
            readingToken = sensor->ReadingChanged::add(ref new TypedEventHandler<LightSensor^, LightSensorReadingChangedEventArgs^>(this, &Scenario1::ReadingChanged));
        }
        else
        {
...
void Scenario1::ReadingChanged(LightSensor^ sender, LightSensorReadingChangedEventArgs^ e)
{
