...
//
// Scenario01_DelegationTickets.xaml.cpp
// Implementation of the Scenario01_DelegationTickets class
//

#include "pch.h"
#include "Scenario01_DelegationTickets.xaml.h"
...
Scenario01_DelegationTickets::Scenario01_DelegationTickets()
{
    InitializeComponent();
}
...
void Scenario01_DelegationTickets::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void Scenario01_DelegationTickets::SignInButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void Scenario01_DelegationTickets::SignOutButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    AccessTicket = "";
