...
//
// Scenario01_DelegationTickets.xaml.h
// Declaration of the Scenario01_DelegationTickets class
//

#pragma once

#include "pch.h"
#include "Scenario01_DelegationTickets.g.h"
...
namespace SDKSample
{
    namespace MicrosoftAccount
    {
        ...
        public ref class Scenario01_DelegationTickets sealed
        {
        public:
            Scenario01_DelegationTickets();
