...
void Scenario1::VisibilityChanged(Object^ sender, VisibilityChangedEventArgs^ e)
{
    ...
    if (ScenarioDisableButton->IsEnabled)
    {
        if (e->Visible)
        {
            ...
            readingToken = compass->ReadingChanged::add(ref new TypedEventHandler<Compass^, CompassReadingChangedEventArgs^>(this, &Scenario1::ReadingChanged));
        }
        else
        {
...
void Scenario1::ReadingChanged(Compass^ sender, CompassReadingChangedEventArgs^ e)
{
