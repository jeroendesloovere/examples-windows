...
void Scenario3::CancelActiveDownloads()
{
...
void Scenario3::ToastNotificationButton_Click(Object^ sender, RoutedEventArgs^ e)
{
...
void Scenario3::TileNotificationButton_Click(Object^ sender, RoutedEventArgs^ e)
{
    // Create a downloader and associate all its downloads with the transfer group used for this scenario.
    BackgroundDownloader^ downloader = ref new BackgroundDownloader();
    downloader->TransferGroup = notificationsGroup;
...
void Scenario3::RunDownloads(BackgroundDownloader^ downloader, ScenarioType type)
{
...
bool Scenario3::TryCreateDownloadAsync(
...
{
    String^ sourceString = serverAddressField->Text + delaySeconds;
...
void Scenario3::RunDownload(DownloadOperation^ download)
{
...
void Scenario3::LogException(String^ title, Exception^ ex, DownloadOperation^ download)
{
    String^ fullTitle;
    if (download != nullptr)
    {
...
void Scenario3::Log(String^ message)
{
    outputField->Text += message + "\r\n";
}

void Scenario3::LogStatus(String^ message, NotifyType type)
{
