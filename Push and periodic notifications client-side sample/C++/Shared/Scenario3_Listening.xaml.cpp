...
#include "pch.h"
#include "Scenario3_Listening.xaml.h"
...
void SDKSample::SDKTemplate::Scenario3::AddCallback_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::SDKTemplate::Scenario3::RemoveCallback_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::SDKTemplate::Scenario3::OnPushNotificationReceived(PushNotificationChannel^ sender, PushNotificationReceivedEventArgs^ e)
{
    ...
    dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler([this, text] ()
    {
