...
#include "pch.h"
#include "Scenario5_BadgePoll.xaml.h"
...
void SDKSample::SDKTemplate::Scenario5::StartBadgePolling_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
...
void SDKSample::SDKTemplate::Scenario5::StopBadgePolling_Click(Platform::Object^ sender, RoutedEventArgs^ e)
{
