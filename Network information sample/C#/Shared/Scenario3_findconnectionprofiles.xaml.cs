...
namespace NetworkInformationApi
{
    ...
    /// </summary>
    public sealed partial class FindConnectionProfiles : Page
    {
        // A pointer back to the main page.  This is needed if you want to call methods in MainPage such
        // as NotifyUser()
        MainPage rootPage = MainPage.Current;

        public FindConnectionProfiles()
        {
        ...
        private async void PrintConnectionProfiles(IReadOnlyList<ConnectionProfile> connectionProfiles)
        {
