...
namespace SDKTemplate
{
    public partial class MainPage : Page
    {
        ...
        List<Scenario> scenarios = new List<Scenario>
        {
            ...
            new Scenario() { Title = "Find Connection Profiles", ClassType = typeof(NetworkInformationApi.FindConnectionProfiles) },
            ...
            new Scenario() { Title = "Get Network Usage", ClassType = typeof(NetworkInformationApi.ProfileLocalUsageData) },
            new Scenario() { Title = "Get Connectivity Intervals", ClassType = typeof(NetworkInformationApi.ProfileConnectivityIntervals) },
            new Scenario() { Title = "Get Attributed Network Usage", ClassType = typeof(NetworkInformationApi.GetAttributedNetworkUsage) }
        };
    }
