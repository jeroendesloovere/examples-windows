...
// Scenario2_connectionprofilelist.xaml.cpp
// Implementation of the ConnectionProfileList class

#include "pch.h"
#include "Scenario2_connectionprofilelist.xaml.h"
...
String^ ConnectionProfileList::GetWlanConnectionProfileDetailsInfo(Windows::Networking::Connectivity::WlanConnectionProfileDetails^ wlanConnectionProfileDetails)
{
    String^ wlanDetails = "";
...
String^ ConnectionProfileList::GetWwanConnectionProfileDetailsInfo(Windows::Networking::Connectivity::WwanConnectionProfileDetails^ wwanConnectionProfileDetails)
{
    String^ wwanDetails = "";
