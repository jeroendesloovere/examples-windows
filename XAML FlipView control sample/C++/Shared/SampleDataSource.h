    ...
    namespace FlipViewData // namespace Controls_FlipView.Data in C#
    {
        ...
        public:
            SampleDataSource()
            {
                ...
                SampleDataItem^ item;
                item = ref new SampleDataItem("Cliff", "item", "Cliff.jpg");
                _items->Append(item);

                item = ref new SampleDataItem("Grapes", "item", "Grapes.jpg");
                _items->Append(item);

                item = ref new SampleDataItem("Rainier", "item", "Rainier.jpg");
                _items->Append(item);

                item = ref new SampleDataItem("Sunset", "item", "Sunset.jpg");
                _items->Append(item);

                item = ref new SampleDataItem("Valley", "item", "Valley.jpg");
                _items->Append(item);
            }
