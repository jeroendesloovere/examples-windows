...
using namespace SDKSample::DataReaderWriter;
...
void SDKSample::DataReaderWriter::WriteReadStream::TransferData(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
