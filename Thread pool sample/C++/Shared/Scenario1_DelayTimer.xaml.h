...
#include "Scenario1_DelayTimer.g.h"
...
namespace SDKSample
{
    namespace ThreadPool
    {
        ...
        private:
            ...
            void DelayMs_TextChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::TextChangedEventArgs^ e);
        };
    }
}
