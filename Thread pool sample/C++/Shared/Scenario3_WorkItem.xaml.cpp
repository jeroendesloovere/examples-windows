...
//
// Scenario3_WorkItem.xaml.cpp
// Implementation of the WorkItemScenario class
//

#include "pch.h"
#include "Scenario3_WorkItem.xaml.h"
...
void  SDKSample::ThreadPool::WorkItemScenario::OnNavigatedTo(NavigationEventArgs^ e)
{
    ...
    Priority->SelectedIndex = WorkItemSelectedIndex;
...
{
    WorkItemSelectedIndex = Priority->SelectedIndex;
}
...
void  SDKSample::ThreadPool::WorkItemScenario::UpdateUI(Status status)
{
    ...
    WorkItemInfo->Text = "Work item priority = " + SDKSample::ThreadPool::WorkPriority.ToString();
