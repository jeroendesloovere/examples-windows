...
#include "pch.h"
#include "Scenario2_Settings.xaml.h"
...
{
    roamingSettings->Values->Insert(settingName, dynamic_cast<PropertyValue^>(PropertyValue::CreateString(settingValue)));
...
{
    String^ value = safe_cast<String^>(roamingSettings->Values->Lookup(settingName));
