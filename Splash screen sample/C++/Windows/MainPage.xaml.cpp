...
/// <summary>
/// When user chooses different scenario, pop up status messages.
/// </summary>
/// <param name="sender">Source of this event.</param>
/// <param name="e">Event data that describes the scenario selection changes.</param>
...
/// <summary>
/// Trigger when user clicking on footer links.
/// </summary>
/// <param name="sender">Source of this event.</param>
