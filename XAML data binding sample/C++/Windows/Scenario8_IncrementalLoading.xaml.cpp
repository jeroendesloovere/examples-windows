...
#include "pch.h"
#include "Scenario8_IncrementalLoading.xaml.h"
#include "Team.h"
...
void SDKSample::DataBinding::Scenario8::Scenario8Reset(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	vectorChangedHandlerToken = employees->VectorChanged += ref new Windows::UI::Xaml::Interop::BindableVectorChangedEventHandler(this, &Scenario8::BindableVectorChanged);
