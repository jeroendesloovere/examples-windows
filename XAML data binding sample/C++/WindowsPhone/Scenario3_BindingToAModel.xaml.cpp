...
#include "pch.h"
#include "Scenario3_BindingToAModel.xaml.h"
#include "Employee.h"
...
Scenario3::Scenario3()
{
	...
	_employee->PropertyChanged += ref new Windows::UI::Xaml::Data::PropertyChangedEventHandler(this, &Scenario3::employeeChanged);
...
void Scenario3::employeeChanged(Object^ sender, Windows::UI::Xaml::Data::PropertyChangedEventArgs^ e)
{
