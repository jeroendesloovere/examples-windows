...
void MainPage::NavigateToFilePage()
{
    TypeName scenarioType = { MainPage::Current->scenarios[2].ClassName, TypeKind::Custom };
    ScenarioFrame->Navigate(scenarioType);
}

void MainPage::NavigateToProtocolPage()
{
    TypeName scenarioType = { MainPage::Current->scenarios[3].ClassName, TypeKind::Custom };
    ScenarioFrame->Navigate(scenarioType);
}
