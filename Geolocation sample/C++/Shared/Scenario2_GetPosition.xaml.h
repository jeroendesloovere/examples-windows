...
namespace SDKSample
{
    namespace GeolocationCPP
    {
        ...
        private:
            ...
            void GetGeolocation(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
            void CancelGetGeolocation(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
            void SetDesiredAccuracyInMeters(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
