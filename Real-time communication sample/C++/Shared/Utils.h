...
namespace SDKSample
{
    ...
    {
    internal:
        void Initialize(Windows::UI::Xaml::Controls::TextBlock^ statusMessage, Windows::UI::Core::CoreDispatcher^ dispatcher);
        void Deinitialize();
    ...
    private:
        ...
        Windows::UI::Xaml::Controls::TextBlock^ _statusMessage;
