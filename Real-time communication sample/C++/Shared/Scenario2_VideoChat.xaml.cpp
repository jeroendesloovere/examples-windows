...
void VideoChat::OnNavigatingFrom(Windows::UI::Xaml::Navigation::NavigatingCancelEventArgs^ e)
{
...
void VideoChat::OnNavigatedFrom(NavigationEventArgs^ e)
{
    _sdkSample.Deinitialize();
}

void VideoChat::CallButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void VideoChat::EndCallButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
task<void> VideoChat::Initialize()
{
    ...
    }).then([this](task<bool> asyncInfo)
    {
        ...
        if (succeed)
        {
            ...
            {
                _device = device;
                _mediaCaptureFailedEventRegistrationToken = _device->Failed += ref new CaptureFailedHandler(this, &VideoChat::OnMediaCaptureFailed);
                _incomingConnectionEventRegistrationToken = _device->IncomingConnectionEvent += ref new IncomingConnectionEventHandler(this, &VideoChat::OnIncomingConnection);
...
task<void> VideoChat::OnInitializeCompleted(Windows::Foundation::HResult hr)
{
    ...
    {        
        ...
        return task<void>(_dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal, ref new Windows::UI::Core::DispatchedHandler([this]()
        {
            ...
            {
                _mediaElementFailedEventRegistrationToken = RemoteVideo->MediaFailed += ref new Windows::UI::Xaml::ExceptionRoutedEventHandler(this, &VideoChat::VideoPlaybackErrorHandler);
            }
...
task<void> VideoChat::Deactivate()
{
    _active = false;
...
task<void> VideoChat::StartRecordingToCustomSinkAsync()
{
...
void VideoChat::OnIncomingConnection(Microsoft::Samples::SimpleCommunication::StspMediaSinkProxy^ sender, Microsoft::Samples::SimpleCommunication::IncomingConnectionEventArgs^ args)
{
    args->Accept();
...
void VideoChat::OnMediaCaptureFailed(CaptureDevice^ sender, CaptureFailedEventArgs^ errorEventArgs)
{
...
void VideoChat::VideoPlaybackErrorHandler(Platform::Object^ sender, Windows::UI::Xaml::ExceptionRoutedEventArgs^ e)
{
...
void VideoChat::LockScenarioChange()
{
    InterlockedCompareExchange(&_navigationDisabled, TRUE, FALSE);
}

void VideoChat::UnlockScenarioChange()
{
