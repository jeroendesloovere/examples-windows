...
/// <dictionary target='parameter'>func</dictionary>
/// <dictionary target='variable'>args,localclient,obj,preffered</dictionary>
/// <dictionary target='member'>wireup</dictionary>
        ...
        actionTransitionFunctions: {
            ...
            streaming: {
                ...
                latencyModeToggled: function () {
                    ...
                    currLocalHostVideo.pause();
                    this._latencyMode = (this._latencyMode === latencyModes.highLatency) ?
